...
7.1: 
I am going to try motions that simulate an actual walk.
The first motion of which should actual deter the
freejoint version of the model from tripping over and 
falling.
